...
curl --location -X POST --form "image=@${HOME_PATH}CatPrinter/app/btc_paper_wallet/privatekey-qrcode.png" 'localhost:5000'
...
curl --location -X POST --form "image=@${HOME_PATH}CatPrinter/app/btc_paper_wallet/balancekey-qrcode.png" 'localhost:5000'

curl --location -X POST --form text="Balance & transactions: (blockchain.com)" --form 'feed="100"' 'localhost:5000'

curl --location -X POST --form text="------------------------------" --form 'feed="100"' 'localhost:5000'

curl --location -X POST --form "image=@${HOME_PATH}CatPrinter/app/btc_paper_wallet/publicwalletqr.png" 'localhost:5000'
...
curl --location -X POST --form "image=@${HOME_PATH}CatPrinter/app/btc_paper_wallet/btc_logo.png" --form 'feed="100"' 'localhost:5000'
